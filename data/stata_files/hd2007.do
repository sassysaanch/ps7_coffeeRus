...
*
insheet using "C:\DCT\hd2007_data_stata.csv", comma clear
...
label define label_deathyr 2008 " "
...
label define label_cbsa 10020 "Abbeville"
...
label define label_cbsa 17660 "Coeur d^Alene",add
...
label define label_csa 102 "Albany-Corvallis-Lebanon"
...
label define label_dfrcgid 188 "Theological seminaries, Bible colleges, other faith-related, highest level-bachelor^s degree/1",add
label define label_dfrcgid 189 "Theological seminaries, Bible colleges, other faith-related, highest level-bachelor^s degree/2",add
...
label define label_dfrcgid 199 "Other health professions schools, highest level of offering-bachelor^s degree",add
...
label define label_dfrcgid 208 "Schools of art, music, and design, highest level of offering- bachelor^s degree",add
...
label define label_dfrcgid 215 "For-profit, 4 year, degree-granting no Carnegie classification and highest degree-Master^s",add
label define label_dfrcgid 216 "For-profit, 4 year, degree-granting no Carnegie classification and highest degree-Bachelor^s",add
