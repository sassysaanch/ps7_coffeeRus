...
*
insheet using "C:\DCT\hd2019_data_stata.csv", comma clear
label data "dct_hd2019"
...
label define label_deathyr 2019 "2019"
...
label define label_c18ipug 1 "Associate^s Colleges: High Transfer"
label define label_c18ipug 2 "Associate^s Colleges: Mixed Transfer/Career & Technical",add
label define label_c18ipug 3 "Associate^s Colleges: High Career & Technical",add
label define label_c18ipug 4 "Special Focus: Two-Year Institution",add
label define label_c18ipug 5 "Baccalaureate/Associates Colleges",add
label define label_c18ipug 6 "Arts & sciences focus, no graduate coexistence",add
label define label_c18ipug 7 "Arts & sciences focus, some graduate coexistence",add
label define label_c18ipug 8 "Arts & sciences focus, high graduate coexistence",add
label define label_c18ipug 9 "Arts & sciences plus professions, no graduate coexistence",add
label define label_c18ipug 10 "Arts & sciences plus professions, some graduate coexistence",add
label define label_c18ipug 11 "Arts & sciences plus professions, high graduate coexistence",add
label define label_c18ipug 12 "Balanced arts & sciences/professions, no graduate coexistence",add
label define label_c18ipug 13 "Balanced arts & sciences/professions, some graduate coexistence",add
label define label_c18ipug 14 "Balanced arts & sciences/professions, high graduate coexistence",add
label define label_c18ipug 15 "Professions plus arts & sciences, no graduate coexistence",add
label define label_c18ipug 16 "Professions plus arts & sciences, some graduate coexistence",add
label define label_c18ipug 17 "Professions plus arts & sciences, high graduate coexistence",add
label define label_c18ipug 18 "Professions focus, no graduate coexistence",add
label define label_c18ipug 19 "Professions focus, some graduate coexistence",add
label define label_c18ipug 20 "Professions focus, high graduate coexistence",add
label define label_c18ipug 0 "Not Classified (Exclusively Graduate Programs)",add
label define label_c18ipug -2 "Not applicable, not in Carnegie universe (not accredited or nondegree-granting)",add
label values c18ipug label_c18ipug
label define label_c18ipgrd 1 "Postbaccalaureate: Single program-Education"
label define label_c18ipgrd 2 "Postbaccalaureate: Single program-Business",add
label define label_c18ipgrd 3 "Postbaccalaureate: Single program-Other",add
label define label_c18ipgrd 4 "Postbaccalaureate: Comprehensive programs",add
label define label_c18ipgrd 5 "Postbaccalaureate: Arts & sciences-dominant",add
label define label_c18ipgrd 6 "Postbaccalaureate: Education-dominant, with Arts & Sciences",add
label define label_c18ipgrd 7 "Postbaccalaureate: Business-dominant, with Arts & Sciences",add
label define label_c18ipgrd 8 "Postbaccalaureate: Other-dominant, with Arts & Sciences",add
label define label_c18ipgrd 9 "Postbaccalaureate: Education-dominant, with other professional programs",add
label define label_c18ipgrd 10 "Postbaccalaureate: Business-dominant, with other professional programs",add
label define label_c18ipgrd 11 "Postbaccalaureate: Other-dominant, with other professional programs",add
label define label_c18ipgrd 12 "Research Doctoral: Single program-Education",add
label define label_c18ipgrd 13 "Research Doctoral: Single program-Other",add
label define label_c18ipgrd 14 "Research Doctoral: Comprehensive programs, with medical/veterinary school",add
label define label_c18ipgrd 15 "Research Doctoral: Comprehensive programs, no medical/veterinary school",add
label define label_c18ipgrd 16 "Research Doctoral: Humanities/social sciences-dominant",add
label define label_c18ipgrd 17 "Research Doctoral: STEM-dominant",add
label define label_c18ipgrd 18 "Research Doctoral: Professional-dominant",add
label define label_c18ipgrd 0 "Not classified (Exclusively Undergraduate)",add
label define label_c18ipgrd -2 "Not applicable, not in Carnegie universe (not accredited or nondegree-granting)",add
label values c18ipgrd label_c18ipgrd
label define label_c18ugprf 1 "Two-year, higher part-time"
label define label_c18ugprf 2 "Two-year, mixed part/full-time",add
label define label_c18ugprf 3 "Two-year, medium full-time",add
label define label_c18ugprf 4 "Two-year, higher full-time",add
label define label_c18ugprf 5 "Four-year, higher part-time",add
label define label_c18ugprf 6 "Four-year, medium full-time, inclusive, lower transfer-in",add
label define label_c18ugprf 7 "Four-year, medium full-time, inclusive, higher transfer-in",add
label define label_c18ugprf 8 "Four-year, medium full-time, selective, lower transfer-in",add
label define label_c18ugprf 9 "Four-year, medium full-time , selective, higher transfer-in",add
label define label_c18ugprf 10 "Four-year, full-time, inclusive, lower transfer-in",add
label define label_c18ugprf 11 "Four-year, full-time, inclusive, higher transfer-in",add
label define label_c18ugprf 12 "Four-year, full-time, selective, lower transfer-in",add
label define label_c18ugprf 13 "Four-year, full-time, selective, higher transfer-in",add
label define label_c18ugprf 14 "Four-year, full-time, more selective, lower transfer-in",add
label define label_c18ugprf 15 "Four-year, full-time, more selective, higher transfer-in",add
label define label_c18ugprf 0 "Not classified (Exclusively Graduate)",add
label define label_c18ugprf -2 "Not applicable, not in Carnegie universe (not accredited or nondegree-granting)",add
label values c18ugprf label_c18ugprf
label define label_c18enprf 1 "Exclusively undergraduate two-year"
label define label_c18enprf 2 "Exclusively undergraduate four-year",add
label define label_c18enprf 3 "Very high undergraduate",add
label define label_c18enprf 4 "High undergraduate",add
label define label_c18enprf 5 "Majority undergraduate",add
label define label_c18enprf 6 "Majority graduate",add
label define label_c18enprf 7 "Exclusively graduate",add
label define label_c18enprf -2 "Not applicable, not in Carnegie universe (not accredited or nondegree-granting)",add
label values c18enprf label_c18enprf
label define label_c18szset 1 "Two-year, very small"
label define label_c18szset 2 "Two-year, small",add
label define label_c18szset 3 "Two-year, medium",add
label define label_c18szset 4 "Two-year, large",add
label define label_c18szset 5 "Two-year, very large",add
label define label_c18szset 6 "Four-year, very small, primarily nonresidential",add
label define label_c18szset 7 "Four-year, very small, primarily residential",add
label define label_c18szset 8 "Four-year, very small, highly residential",add
label define label_c18szset 9 "Four-year, small, primarily nonresidential",add
label define label_c18szset 10 "Four-year, small, primarily residential",add
label define label_c18szset 11 "Four-year, small, highly residential",add
label define label_c18szset 12 "Four-year, medium, primarily nonresidential",add
label define label_c18szset 13 "Four-year, medium, primarily residential",add
label define label_c18szset 14 "Four-year, medium, highly residential",add
label define label_c18szset 15 "Four-year, large, primarily nonresidential",add
label define label_c18szset 16 "Four-year, large, primarily residential",add
label define label_c18szset 17 "Four-year, large, highly residential",add
label define label_c18szset 18 "Exclusively graduate/professional",add
label define label_c18szset -2 "Not applicable, not in Carnegie universe (not accredited or nondegree-granting)",add
label values c18szset label_c18szset
...
label define label_f1syscod 303680 "Manufacturerís Technical Institutes, Inc",add
...
label define label_cbsa 12060 "Atlanta-Sandy Springs-Alpharetta, GA",add
...
label define label_cbsa 12420 "Austin-Round Rock-Georgetown, TX",add
...
label define label_cbsa 13620 "Berlin, NH",add
...
label define label_cbsa 13980 "Blacksburg-Christiansburg, VA",add
...
label define label_cbsa 14740 "Bremerton-Silverdale-Port Orchard, WA",add
...
label define label_cbsa 15380 "Buffalo-Cheektowaga, NY",add
...
label define label_cbsa 19430 "Dayton-Kettering, OH",add
label define label_cbsa 19460 "Decatur, AL",add
...
label define label_cbsa 21580 "Espa√±ola, NM",add
label define label_cbsa 21660 "Eugene-Springfield, OR",add
label define label_cbsa 21700 "Eureka-Arcata, CA",add
...
label define label_cbsa 22220 "Fayetteville-Springdale-Rogers, AR",add
...
label define label_cbsa 24340 "Grand Rapids-Kentwood, MI",add
...
label define label_cbsa 24860 "Greenville-Anderson, SC",add
...
label define label_cbsa 25540 "Hartford-East Hartford-Middletown, CT",add
...
label define label_cbsa 25940 "Hilton Head Island-Bluffton, SC",add
...
label define label_cbsa 27530 "Jasper, AL",add
...
label define label_cbsa 28700 "Kingsport-Bristol, TN-VA",add
...
label define label_cbsa 29300 "LaGrange, GA-AL",add
...
label define label_cbsa 31860 "Mankato, MN",add
...
label define label_cbsa 32420 "Mayag√ºez, PR",add
...
label define label_cbsa 33340 "Milwaukee-Waukesha, WI",add
...
label define label_cbsa 34350 "Mount Gay-Shamrock, WV",add
...
label define label_cbsa 35660 "Niles, MI",add
...
label define label_cbsa 36500 "Olympia-Lacey-Tumwater, WA",add
...
label define label_cbsa 36837 "Ottawa, IL",add
...
label define label_cbsa 38060 "Phoenix-Mesa-Chandler, AZ",add
...
label define label_cbsa 39150 "Prescott Valley-Prescott, AZ",add
...
label define label_cbsa 40900 "Sacramento-Roseville-Folsom, CA",add
...
label define label_cbsa 41220 "St. Marys, GA",add
...
label define label_cbsa 41740 "San Diego-Chula Vista-Carlsbad, CA",add
label define label_cbsa 41780 "Sandusky, OH",add
label define label_cbsa 41820 "Sanford, NC",add
label define label_cbsa 41860 "San Francisco-Oakland-Berkeley, CA",add
label define label_cbsa 41900 "San Germ√°n, PR",add
label define label_cbsa 41940 "San Jose-Sunnyvale-Santa Clara, CA",add
label define label_cbsa 41980 "San Juan-Bayam√≥n-Caguas, PR",add
...
label define label_cbsa 42700 "Sebring-Avon Park, FL",add
...
label define label_cbsa 44420 "Staunton, VA",add
...
label define label_cbsa 45940 "Trenton-Princeton, NJ",add
...
label define label_cbsa 46700 "Vallejo, CA",add
...
label define label_cbsa 47300 "Visalia, CA",add
...
label define label_cbsa 48140 "Wausau-Weston, WI",add
...
label define label_csa 107 "Altoona-Huntingdon, PA",add
label define label_csa 108 "Amarillo-Pampa-Borger, TX",add
label define label_csa 118 "Appleton-Oshkosh-Neenah, WI",add
label define label_csa 120 "Asheville-Marion-Brevard, NC",add
label define label_csa 122 "Atlanta--Athens-Clarke County--Sandy Springs, GA-AL",add
...
label define label_csa 160 "Buffalo-Cheektowaga-Olean, NY",add
label define label_csa 161 "Burlington-Fort Madison-Keokuk, IA-IL-MO",add
label define label_csa 162 "Burlington-South Burlington-Barre, VT",add
label define label_csa 163 "Cape Coral-Fort Myers-Naples, FL",add
...
label define label_csa 174 "Chattanooga-Cleveland-Dalton, TN-GA",add
...
label define label_csa 212 "Dayton-Springfield-Kettering, OH",add
...
label define label_csa 222 "Dothan-Ozark, AL",add
...
label define label_csa 246 "Fayetteville-Sanford-Lumberton, NC",add
label define label_csa 258 "Fort Wayne-Huntington-Auburn, IN",add
label define label_csa 260 "Fresno-Madera-Hanford, CA",add
label define label_csa 264 "Gainesville-Lake City, FL",add
label define label_csa 266 "Grand Rapids-Kentwood-Muskegon, MI",add
label define label_csa 267 "Green Bay-Shawano, WI",add
label define label_csa 268 "Greensboro--Winston-Salem--High Point, NC",add
label define label_csa 272 "Greenville-Kinston-Washington, NC",add
...
label define label_csa 277 "Harrisonburg-Staunton, VA",add
label define label_csa 278 "Hartford-East Hartford, CT",add
label define label_csa 279 "Hattiesburg-Laurel, MS",add
...
label define label_csa 313 "Kennewick-Richland-Walla Walla, WA",add
label define label_csa 314 "Kerrville-Fredericksburg, TX",add
label define label_csa 315 "Knoxville-Morristown-Sevierville, TN",add
...
label define label_csa 332 "Las Vegas-Henderson, NV",add
...
label define label_csa 350 "Louisville/Jefferson County--Elizabethtown--Bardstown, KY-IN",add
label define label_csa 352 "Lubbock-Plainview-Levelland, TX",add
...
label define label_csa 359 "Mankato-New Ulm, MN",add
label define label_csa 360 "Mansfield-Ashland-Bucyrus, OH",add
label define label_csa 362 "Martin-Union City, TN",add
label define label_csa 364 "Mayag√ºez-San Germ√°n, PR",add
...
label define label_csa 370 "Miami-Port St. Lucie-Fort Lauderdale, FL",add
...
label define label_csa 384 "Monroe-Ruston, LA",add
label define label_csa 388 "Montgomery-Selma-Alexander City, AL",add
...
label define label_csa 422 "Orlando-Lakeland-Deltona, FL",add
...
label define label_csa 429 "Phoenix-Mesa, AZ",add
...
label define label_csa 444 "Pueblo-Ca√±on City, CO",add
...
label define label_csa 480 "Salisbury-Cambridge, MD-DE",add
label define label_csa 482 "Salt Lake City-Provo-Orem, UT",add
label define label_csa 484 "San Antonio-New Braunfels-Pearsall, TX",add
label define label_csa 488 "San Jose-San Francisco-Oakland, CA",add
label define label_csa 490 "San Juan-Bayam√≥n, PR",add
label define label_csa 496 "Savannah-Hinesville-Statesboro, GA",add
label define label_csa 497 "Scottsboro-Fort Payne, AL",add
...
label define label_csa 517 "Spencer-Spirit Lake, IA",add
...
label define label_necta 71650 "Boston-Cambridge-Newton, MA-NH",add
...
label define label_necta 73450 "Hartford-East Hartford-Middletown, CT",add
...
label define label_countycd 72021 "BayamÛn Municipio, PR",add
...
label define label_dfrcgid 96 "Doctoral Universities: Highest Research Activity, Public/1 of 3"
label define label_dfrcgid 97 "Doctoral Universities: Highest Research Activity, Public/2 of 3",add
label define label_dfrcgid 98 "Doctoral Universities: Highest Research Activity, Public/3 of 3",add
label define label_dfrcgid 99 "Doctoral Universities: Highest Research Activity, private not-for-profit",add
label define label_dfrcgid 100 "Doctoral Universities: Higher Research Activity, public/1 of 3",add
label define label_dfrcgid 101 "Doctoral Universities: Higher Research Activity, public/2 of 3",add
label define label_dfrcgid 102 "Doctoral Universities: Higher Research Activity, public/3 of 3",add
label define label_dfrcgid 103 "Doctoral Universities: Higher Research Activity, private not-for-profit",add
label define label_dfrcgid 104 "Doctoral/Professional Universities, public",add
label define label_dfrcgid 105 "Doctoral/Professional Universities, private not-for-profit/1 of 3",add
label define label_dfrcgid 106 "Doctoral/Professional Universities, private not-for-profit/2 of 3",add
label define label_dfrcgid 107 "Doctoral/Professional Universities, private not-for-profit/3 of 3",add
label define label_dfrcgid 108 "Doctoral/Professional Universities, private for-profit",add
label define label_dfrcgid 109 "Masters Colleges and Universities (larger programs), public/1 of 5",add
label define label_dfrcgid 110 "Masters Colleges and Universities (larger programs), public/2 of 5",add
label define label_dfrcgid 111 "Masters Colleges and Universities (larger programs), public/3 of 5",add
label define label_dfrcgid 112 "Masters Colleges and Universities (larger programs), public/4 of 5",add
label define label_dfrcgid 113 "Masters Colleges and Universities (larger programs), public/5 of 5",add
label define label_dfrcgid 114 "Masters Colleges and Universities (larger programs), private not-for-profit/1 of 5",add
label define label_dfrcgid 115 "Masters Colleges and Universities (larger programs), private not-for-profit/2 of 5",add
label define label_dfrcgid 116 "Masters Colleges and Universities (larger programs), private not-for-profit/3 of 5",add
label define label_dfrcgid 117 "Masters Colleges and Universities (larger programs), private not-for-profit/4 of 5",add
label define label_dfrcgid 118 "Masters Colleges and Universities (larger programs), private not-for-profit/5 of 5",add
label define label_dfrcgid 119 "Masters Colleges and Universities (larger programs), private for-profit",add
label define label_dfrcgid 120 "Masters Colleges and Universities (medium programs), public/1 of 2",add
label define label_dfrcgid 121 "Masters Colleges and Universities (medium programs), public/2 of 2",add
label define label_dfrcgid 122 "Masters Colleges and Universities (medium programs), private not-for-profit/1 of 4",add
label define label_dfrcgid 123 "Masters Colleges and Universities (medium programs), private not-for-profit/2 of 4",add
label define label_dfrcgid 124 "Masters Colleges and Universities (medium programs), private not-for-profit/3 of 4",add
label define label_dfrcgid 125 "Masters Colleges and Universities (medium programs), private not-for-profit/4 of 4",add
label define label_dfrcgid 126 "Masters Colleges and Universities (medium programs), private for-profit",add
label define label_dfrcgid 127 "Masters Colleges and Universities (smaller programs), public",add
label define label_dfrcgid 128 "Masters Colleges and Universities (smaller programs), private not-for-profit/1 of 2",add
label define label_dfrcgid 129 "Masters Colleges and Universities (smaller programs), private not-for-profit/2 of 2",add
label define label_dfrcgid 130 "Masters Colleges and Universities (smaller programs), private for-profit",add
label define label_dfrcgid 131 "Baccalaureate Colleges--Arts & Sciences, public",add
label define label_dfrcgid 132 "Baccalaureate Colleges--Arts & Sciences, private not-for-profit/1 of 7",add
label define label_dfrcgid 133 "Baccalaureate Colleges--Arts & Sciences, private not-for-profit/2 of 7",add
label define label_dfrcgid 134 "Baccalaureate Colleges--Arts & Sciences, private not-for-profit/3 of 7",add
label define label_dfrcgid 135 "Baccalaureate Colleges--Arts & Sciences, private not-for-profit/4 of 7",add
label define label_dfrcgid 136 "Baccalaureate Colleges--Arts & Sciences, private not-for-profit/5 of 7",add
label define label_dfrcgid 137 "Baccalaureate Colleges--Arts & Sciences, private not-for-profit/6 of 7",add
label define label_dfrcgid 138 "Baccalaureate Colleges--Arts & Sciences, private not-for-profit/7 of 7",add
label define label_dfrcgid 139 "Baccalaureate Colleges--Diverse Fields, public/1 of 2",add
label define label_dfrcgid 140 "Baccalaureate Colleges--Diverse Fields, public/2 of 2",add
label define label_dfrcgid 141 "Baccalaureate Colleges--Diverse Fields, private not-for-profit/1 of 6",add
label define label_dfrcgid 142 "Baccalaureate Colleges--Diverse Fields, private not-for-profit/2 of 6",add
label define label_dfrcgid 143 "Baccalaureate Colleges--Diverse Fields, private not-for-profit/3 of 6",add
label define label_dfrcgid 144 "Baccalaureate Colleges--Diverse Fields, private not-for-profit/4 of 6",add
label define label_dfrcgid 145 "Baccalaureate Colleges--Diverse Fields, private not-for-profit/5 of 6",add
label define label_dfrcgid 146 "Baccalaureate Colleges--Diverse Fields, private not-for-profit/6 of 6",add
label define label_dfrcgid 206 "Baccalaureate Colleges--Diverse Fields, private for-profit",add
label define label_dfrcgid 147 "Baccalaureate/Associates Colleges, private not-for-profit",add
label define label_dfrcgid 148 "Theological seminaries/Bible colleges/faith-related institutions, highest level-bachelor^s degree/1 of 3",add
label define label_dfrcgid 149 "Theological seminaries/Bible colleges/faith-related institutions, highest level-bachelor^s degree/2 of 3",add
label define label_dfrcgid 150 "Theological seminaries/Bible colleges/faith-related institutions, highest level-bachelor^s degree/3 of 3",add
label define label_dfrcgid 151 "Theological seminaries/Bible colleges/faith-related institutions, highest level-postbaccalaureate, undergraduate degrees/certificates offered",add
label define label_dfrcgid 152 "Theological seminaries/Bible colleges/faith-related institutions, highest level-postbaccalaureate, undergraduate degree/certificates not offered",add
label define label_dfrcgid 153 "Theological seminaries/Bible colleges/faith-related institutions, highest level-highest level-Doctor^s, undergraduate degrees/certificates offered",add
label define label_dfrcgid 154 "Theological seminaries/Bible colleges/faith-related institutions, highest level-highest level-Doctor^s, undergraduate degrees/certificates not offered",add
label define label_dfrcgid 155 "Theological seminaries/Bible colleges/faith-related institutions, highest level-highest level-Doctor^s, undergraduate degrees/certificates not offered",add
label define label_dfrcgid 157 "Medical schools and medical centers, public",add
label define label_dfrcgid 158 "Medical schools and medical centers, private not-for-profit",add
label define label_dfrcgid 159 "Other health professions schools, public",add
label define label_dfrcgid 160 "Other health professions schools, private not-for-profit/1 of 3",add
label define label_dfrcgid 161 "Other health professions schools, private not-for-profit/2 of 3",add
label define label_dfrcgid 162 "Other health professions schools, private not-for-profit/3 of 3",add
label define label_dfrcgid 164 "Other health professions schools, private for-profit/1 of 2",add
label define label_dfrcgid 165 "Other health professions schools, private for-profit/2 of 2",add
label define label_dfrcgid 167 "Schools of engineering",add
label define label_dfrcgid 169 "Other technology-related schools, private not-for-profit and for-profit",add
label define label_dfrcgid 170 "Schools of business and management, private not-for-profit",add
label define label_dfrcgid 172 "Schools of business and management, private for-profit",add
label define label_dfrcgid 174 "Schools of art, music, and design, private for-profit",add
label define label_dfrcgid 175 "Schools of art, music, and design, Public or private not-for-profit/1 of 2",add
label define label_dfrcgid 176 "Schools of art, music, and design, Public or private not-for-profit/2 of 2",add
label define label_dfrcgid 177 "Schools of law",add
label define label_dfrcgid 179 "Other special-focus institutions",add
label define label_dfrcgid 1 "Degree-granting 4-year with no Carnegie classification, highest degree - bachelor^s, public",add
label define label_dfrcgid 205 "Degree-granting 4-year with no Carnegie classification, highest degree-Doctor^s or Master^s, private for-profit",add
label define label_dfrcgid 207 "Degree-granting 4-year with no Carnegie classification, highest degree-Bachelor^s, private for-profit",add
label define label_dfrcgid 208 "Degree-granting 4-year with no Carnegie classification, highest degree-Bachelor^s, private not-for-profit",add
label define label_dfrcgid 209 "Degree-granting 4-year with no Carnegie classification, highest degree-Master^s private not-for-profit",add
label define label_dfrcgid 156 "Degree-granting four year primarily associates, Theological seminaries/Bible colleges/faith-related institutions",add
label define label_dfrcgid 163 "Degree-granting four-year primarily associate^s, Health professions schools, private for-profit",add
label define label_dfrcgid 166 "Degree-granting four-year primarily associate^s, Health professions schools, public or private not-for-profit",add
label define label_dfrcgid 168 "Degree-granting four-year primarily associate^s, Technology-related schools",add
label define label_dfrcgid 171 "Degree-granting four-year primarily associate^s, Schools of business and management, private for-profit",add
label define label_dfrcgid 173 "Degree-granting four-year primarily associate^s, Schools of art, music, and design, private for-profit",add
label define label_dfrcgid 178 "Degree-granting four-year primarily associate^s, Other special-focus institutions",add
label define label_dfrcgid 194 "Degree-granting four-year, primarily associate^s, Carnegie classification of Associate^s Dominant, public/1 of 3",add
label define label_dfrcgid 195 "Degree-granting four-year, primarily associate^s, Carnegie classification of Associate^s Dominant, public/2 of 3",add
label define label_dfrcgid 196 "Degree-granting four-year, primarily associate^s, Carnegie classification of Associate^s Dominant, public/3 of 3",add
label define label_dfrcgid 197 "Degree-granting four-year, primarily associate^s, Carnegie classification of Associate^s Dominant, private not-for-profit",add
label define label_dfrcgid 198 "Degree-granting four-year, primarily associate^s, Carnegie classification of Associate^s Dominant, private for-profit",add
label define label_dfrcgid 199 "Degree-granting four-year, primarily associate^s, Carnegie classification of Mixed Baccalaureate/Associate^s, public",add
label define label_dfrcgid 200 "Degree-granting four-year, primarily associate^s, Carnegie classification of Mixed Baccalaureate/Associate^s, private not-for-profit",add
label define label_dfrcgid 201 "Degree-granting four-year, primarily associate^s,†Carnegie classification of Mixed Baccalaureate/Associate^s, private for-profit/1 of 2",add
label define label_dfrcgid 202 "Degree-granting four-year, primarily associate^s, Carnegie classification of†Mixed Baccalaureate/Associate^s, private for-profit/2 of 2",add
label define label_dfrcgid 203 "Degree-granting four-year, primarily associate^s, with no Carnegie classification, private not-for-profit",add
label define label_dfrcgid 204 "Degree-granting four-year, primarily associate^s, with no Carnegie classifcation, private for-profit",add
label define label_dfrcgid 64 "Associate^s Colleges: High Transfer-High Traditional, public/1 of 4",add
label define label_dfrcgid 65 "Associate^s Colleges: High Transfer-High Traditional, public/2 of 4",add
label define label_dfrcgid 66 "Associate^s Colleges: High Transfer-High Traditional, public/3 of 4",add
label define label_dfrcgid 67 "Associate^s Colleges: High Transfer-High Traditional, public/4 of 4",add
label define label_dfrcgid 68 "Associate^s Colleges: High Transfer-Mixed Traditional/Nontraditional, public/1 of 4",add
label define label_dfrcgid 69 "Associate^s Colleges: High Transfer-Mixed Traditional/Nontraditional, public/2 of 4",add
label define label_dfrcgid 70 "Associate^s Colleges: High Transfer-Mixed Traditional/Nontraditional, public/3 of 4",add
label define label_dfrcgid 71 "Associate^s Colleges: High Transfer-Mixed Traditional/Nontraditional, public/4 of 4",add
label define label_dfrcgid 72 "Associate^s Colleges: High Transfer-High Nontraditional, Public/1 of 3",add
label define label_dfrcgid 73 "Associate^s Colleges: High Transfer-High Nontraditional, Public/2 of 3",add
label define label_dfrcgid 74 "Associate^s Colleges: High Transfer-High Nontraditional, Public/3 of 3",add
label define label_dfrcgid 75 "Associate^s Colleges: Mixed Transfer/Career & Technical-High Traditional, Public/1 of 4",add
label define label_dfrcgid 76 "Associate^s Colleges: Mixed Transfer/Career & Technical-High Traditional, Public/2 of 4",add
label define label_dfrcgid 77 "Associate^s Colleges: Mixed Transfer/Career & Technical-High Traditional, Public/3 of 4",add
label define label_dfrcgid 78 "Associate^s Colleges: Mixed Transfer/Career & Technical-High Traditional, Public/4 of 4",add
label define label_dfrcgid 79 "Associate^s Colleges: Mixed Transfer/Career & Technical-Mixed Traditional/Nontraditional, Public/1 of 3",add
label define label_dfrcgid 80 "Associate^s Colleges: Mixed Transfer/Career & Technical-Mixed Traditional/Nontraditional, Public/2 of 3",add
label define label_dfrcgid 81 "Associate^s Colleges: Mixed Transfer/Career & Technical-Mixed Traditional/Nontraditional, Public/3 of 3",add
label define label_dfrcgid 82 "Associate^s Colleges: Mixed Transfer/Career & Technical-High Nontraditional, Public/1 of 3",add
label define label_dfrcgid 83 "Associate^s Colleges: Mixed Transfer/Career & Technical-High Nontraditional, Public/2 of 3",add
label define label_dfrcgid 84 "Associate^s Colleges: Mixed Transfer/Career & Technical-High Nontraditional, Public/3 of 3",add
label define label_dfrcgid 85 "Associate^s Colleges: High Career & Technical-High Traditional, public/1 of 2",add
label define label_dfrcgid 86 "Associate^s Colleges: High Career & Technical-High Traditional, public/2 of 2",add
label define label_dfrcgid 87 "Associate^s Colleges: High Career & Technical-High Traditional, private for-profit",add
label define label_dfrcgid 88 "Associate^s Colleges: High Career & Technical-Mixed Traditional/Nontraditional, public/1 of 2",add
label define label_dfrcgid 89 "Associate^s Colleges: High Career & Technical-Mixed Traditional/Nontraditional, public/2 of 2",add
label define label_dfrcgid 90 "Associate^s Colleges: High Career & Technical-Mixed Traditional/Nontraditional, private for-profit",add
label define label_dfrcgid 91 "Associate^s Colleges: High Career & Technical-High Nontraditional, public/1 of 2",add
label define label_dfrcgid 92 "Associate^s Colleges: High Career & Technical-High Nontraditional, public/2 of 2",add
label define label_dfrcgid 93 "Associate^s Colleges: High Career & Technical-High Nontraditional, private for-profit",add
label define label_dfrcgid 94 "Associate colleges: High/Mixed Transfer, private not-for-profit",add
label define label_dfrcgid 95 "Associate colleges: High Career & Technical, private not-for-profit",add
label define label_dfrcgid 181 "Special Focus Two Year: any public",add
label define label_dfrcgid 182 "Special Focus Two Year: Health, private not-for-profit",add
label define label_dfrcgid 183 "Special Focus Two Year: Health, private for-profit/1 of 5",add
label define label_dfrcgid 184 "Special Focus Two Year: Health, private for-profit/2 of 5",add
label define label_dfrcgid 185 "Special Focus Two Year: Health, private for-profit/3 of 5",add
label define label_dfrcgid 186 "Special Focus Two Year: Health, private for-profit/4 of 5",add
label define label_dfrcgid 187 "Special Focus Two Year: Health, private for-profit/5 of 5",add
label define label_dfrcgid 188 "Special Focus Two Year: Technical, private not-for-profit",add
label define label_dfrcgid 189 "Special Focus Two Year: Technical, private for-profit",add
label define label_dfrcgid 190 "Special Focus Two Year: Art & Design, private not-for-profit",add
label define label_dfrcgid 191 "Special Focus Two Year: Art & Design, private for-profit",add
label define label_dfrcgid 192 "Special Focus Two Year: Other, private not-for-profit",add
label define label_dfrcgid 193 "Special Focus Two Year: Other, private for-profit",add
label define label_dfrcgid 225 "Other Associate^s Colleges, public",add
label define label_dfrcgid 226 "Other Associate^s Colleges, private not-for-profit",add
label define label_dfrcgid 227 "Other Associate^s Colleges, private for-profit/1 of 2",add
label define label_dfrcgid 228 "Other Associate^s Colleges, private for-profit/2 of 2",add
label define label_dfrcgid 180 "Tribal Colleges",add
label define label_dfrcgid 214 "U.S. Military Academies",add
label define label_dfrcgid 2 "Nondegree-granting, public, academic year reporter",add
label define label_dfrcgid 3 "Nondegree-granting, public, largest program - cosmetology",add
label define label_dfrcgid 4 "Nondegree-granting, public, largest program - health/1 of 7",add
label define label_dfrcgid 5 "Nondegree-granting, public, largest program - health/2 of 7",add
label define label_dfrcgid 6 "Nondegree-granting, public, largest program - health/3 of 7",add
label define label_dfrcgid 7 "Nondegree-granting, public, largest program - health/4 of 7",add
label define label_dfrcgid 8 "Nondegree-granting, public, largest program - health/5 of 7",add
label define label_dfrcgid 9 "Nondegree-granting, public, largest program - health/6 of 7",add
label define label_dfrcgid 10 "Nondegree-granting, public, largest program - health/7 of 7",add
label define label_dfrcgid 215 "Nondegree-granting, public, largest program - engineering and engineering technologies",add
label define label_dfrcgid 216 "Nondegree-granting, public, largest program - manufacturing, construction, repair, and transportation",add
label define label_dfrcgid 11 "Nondegree-granting, public, largest program - other",add
label define label_dfrcgid 12 "Nondegree-granting, private not-for-profit, academic year reporter",add
label define label_dfrcgid 13 "Nondegree-granting, private not-for-profit, largest program - cosmetology",add
label define label_dfrcgid 14 "Nondegree-granting, private not-for-profit, largest program - health",add
label define label_dfrcgid 217 "Nondegree-granting, private not-for-profit, largest program - manufacturing, construction, repair, and transportation",add
label define label_dfrcgid 219 "Nondegree-granting, private not-for-profit, largest program - engineering and engineering technologies",add
label define label_dfrcgid 15 "Nondegree-granting, private not-for-profit, largest program - other",add
label define label_dfrcgid 16 "Nondegree-granting, private for-profit, academic year reporter/1 of 2",add
label define label_dfrcgid 17 "Nondegree-granting, private for-profit, academic year reporter/2 of 2",add
label define label_dfrcgid 18 "Nondegree-granting, private for-profit, largest program - cosmetology/1 of 36",add
label define label_dfrcgid 19 "Nondegree-granting, private for-profit, largest program - cosmetology/2 of 36",add
label define label_dfrcgid 20 "Nondegree-granting, private for-profit, largest program - cosmetology/3 of 36",add
label define label_dfrcgid 21 "Nondegree-granting, private for-profit, largest program - cosmetology/4 of 36",add
label define label_dfrcgid 22 "Nondegree-granting, private for-profit, largest program - cosmetology/5 of 36",add
label define label_dfrcgid 23 "Nondegree-granting, private for-profit, largest program - cosmetology/6 of 36",add
label define label_dfrcgid 24 "Nondegree-granting, private for-profit, largest program - cosmetology/7 of 36",add
label define label_dfrcgid 25 "Nondegree-granting, private for-profit, largest program - cosmetology/8 of 36",add
label define label_dfrcgid 26 "Nondegree-granting, private for-profit, largest program - cosmetology/9 of 36",add
label define label_dfrcgid 27 "Nondegree-granting, private for-profit, largest program - cosmetology/10 of 36",add
label define label_dfrcgid 28 "Nondegree-granting, private for-profit, largest program - cosmetology/11 of 36",add
label define label_dfrcgid 29 "Nondegree-granting, private for-profit, largest program - cosmetology/12 of 36",add
label define label_dfrcgid 30 "Nondegree-granting, private for-profit, largest program - cosmetology/13 of 36",add
label define label_dfrcgid 31 "Nondegree-granting, private for-profit, largest program - cosmetology/14 of 36",add
label define label_dfrcgid 32 "Nondegree-granting, private for-profit, largest program - cosmetology/15 of 36",add
label define label_dfrcgid 33 "Nondegree-granting, private for-profit, largest program - cosmetology/16 of 36",add
label define label_dfrcgid 34 "Nondegree-granting, private for-profit, largest program - cosmetology/17 of 36",add
label define label_dfrcgid 35 "Nondegree-granting, private for-profit, largest program - cosmetology/18 of 36",add
label define label_dfrcgid 36 "Nondegree-granting, private for-profit, largest program - cosmetology/19 of 36",add
label define label_dfrcgid 37 "Nondegree-granting, private for-profit, largest program - cosmetology/20 of 36",add
label define label_dfrcgid 38 "Nondegree-granting, private for-profit, largest program - cosmetology/21 of 36",add
label define label_dfrcgid 39 "Nondegree-granting, private for-profit, largest program - cosmetology/22 of 36",add
label define label_dfrcgid 40 "Nondegree-granting, private for-profit, largest program - cosmetology/23 of 36",add
label define label_dfrcgid 41 "Nondegree-granting, private for-profit, largest program - cosmetology/24 of 36",add
label define label_dfrcgid 42 "Nondegree-granting, private for-profit, largest program - cosmetology/25 of 36",add
label define label_dfrcgid 43 "Nondegree-granting, private for-profit, largest program - cosmetology/26 of 36",add
label define label_dfrcgid 44 "Nondegree-granting, private for-profit, largest program - cosmetology/27 of 36",add
label define label_dfrcgid 45 "Nondegree-granting, private for-profit, largest program - cosmetology/28 of 36",add
label define label_dfrcgid 46 "Nondegree-granting, private for-profit, largest program - cosmetology/29 of 36",add
label define label_dfrcgid 47 "Nondegree-granting, private for-profit, largest program - cosmetology/30 of 36",add
label define label_dfrcgid 48 "Nondegree-granting, private for-profit, largest program - cosmetology/31 of 36",add
label define label_dfrcgid 49 "Nondegree-granting, private for-profit, largest program - cosmetology/32 of 36",add
label define label_dfrcgid 50 "Nondegree-granting, private for-profit, largest program - cosmetology/33 of 36",add
label define label_dfrcgid 51 "Nondegree-granting, private for-profit, largest program - cosmetology/34 of 36",add
label define label_dfrcgid 52 "Nondegree-granting, private for-profit, largest program - cosmetology/35 of 36",add
label define label_dfrcgid 53 "Nondegree-granting, private for-profit, largest program - cosmetology/36 of 36",add
label define label_dfrcgid 54 "Nondegree-granting, private for-profit, largest program - health/1 of 9",add
label define label_dfrcgid 55 "Nondegree-granting, private for-profit, largest program - health/2 of 9",add
label define label_dfrcgid 56 "Nondegree-granting, private for-profit, largest program - health/3 of 9",add
label define label_dfrcgid 57 "Nondegree-granting, private for-profit, largest program - health/4 of 9",add
label define label_dfrcgid 58 "Nondegree-granting, private for-profit, largest program - health/5 of 9",add
label define label_dfrcgid 59 "Nondegree-granting, private for-profit, largest program - health/6 of 9",add
label define label_dfrcgid 60 "Nondegree-granting, private for-profit, largest program - health/7 of 9",add
label define label_dfrcgid 61 "Nondegree-granting, private for-profit, largest program - health/8 of 9",add
label define label_dfrcgid 62 "Nondegree-granting, private for-profit, largest program - health/9 of 9",add
label define label_dfrcgid 218 "Nondegree-granting, private for-profit, largest program - communications and †communication technologies",add
label define label_dfrcgid 220 "Nondegree-granting, private for-profit, largest program - manufacturing, construction, repair, and transportation/1 of 3",add
label define label_dfrcgid 221 "Nondegree-granting, private for-profit, largest program - manufacturing, construction, repair, and transportation/2 of 3",add
label define label_dfrcgid 222 "Nondegree-granting, private for-profit, largest program - manufacturing, construction, repair, and transportation/3 of 3",add
label define label_dfrcgid 63 "Nondegree-granting, private for-profit, largest program - other",add
label define label_dfrcgid 229 "Degree-granting 4-year public in Puerto Rico",add
label define label_dfrcgid 230 "Degree-granting private not-for-profit in Puerto Rico/1 of 2",add
label define label_dfrcgid 231 "Degree-granting private not-for-profit in Puerto Rico/2 of 2",add
label define label_dfrcgid 232 "Degree-granting private for-profit in Puerto Rico",add
label define label_dfrcgid 233 "Nondegree-granting private for-profit or not-for-profit in Puerto Rico/1 of 2",add
label define label_dfrcgid 234 "Nondegree-granting private for-profit or not-for-profit in Puerto Rico/2 of 2",add
label define label_dfrcgid 223 "Degree-granting four-year in jurisdictions other than Puerto Rico",add
label define label_dfrcgid 224 "Degree-granting less-than 4-year public in Puerto Rico or other jurisdictions",add
label define label_dfrcgid 210 "Non-Title IV, degree-granting",add
label define label_dfrcgid 211 "Non-Title IV, nondegree-granting, largest program - cosmetology",add
label define label_dfrcgid 212 "Non-Title IV, nondegree-granting, largest program - health",add
label define label_dfrcgid 213 "Non-Title IV, nondegree-granting, largest program - other",add
